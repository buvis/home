...
description: Scan awesome-claude-code for new repos since last check. Triggers on "scan awesome-cc", "any new repos?", "check for new Claude Code tools", "check notifications".
---
