...
description: >
  Scans the rockerBOO/awesome-neovim GitHub repository for new plugin entries added since the last
  scan, then updates the tracking zettelkasten note at
  /Users/bob/bim/zettelkasten/20260227122532.md with any plugins not already present.

  Use this skill whenever the user says anything like: "check awesome-neovim", "scan neovim plugins",
  "any new neovim plugins?", "update my neovim list", "check for new neovim tools",
  "new plugins in awesome-neovim", or pastes the URL
