...
7. **Write the report** with the Write tool to `dev/local/prds/backlog-review-{YYYY-MM-DD}.md` (sibling of the lifecycle dirs, never inside them; never via shell redirect). Format below. Chat output stays at three sentences plus the verdict.
