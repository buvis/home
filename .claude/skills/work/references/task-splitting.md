...
**Never parallelize original plan tasks** - the one-at-a-time rule remains for all non-rework tasks: `state.tasks` accuracy and per-task attempt logging depend on it.
