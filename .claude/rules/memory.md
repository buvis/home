...
- **Global / cross-machine memory, preference rules, and reusable methodology** (how to communicate, durable working preferences, skills) live under `~/.claude/` (`rules/`, `CLAUDE.md`, `skills/`) and MUST be committed to the **buvis dotfiles bare repo** so they survive on a new machine:
