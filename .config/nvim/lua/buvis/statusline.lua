...
local update_statusline = function(default, action)
  ...
  elseif filetype == 'qf' then
    if action == 'blur' then
      result = '%{v:lua.buvis.statusline.gutterpadding()}'
        .. ' '
        .. ' '
        .. ' '
        .. ' '
...
statusline.blur_statusline = function()
  ...
  local blurred = '%{v:lua.buvis.statusline.gutterpadding()}'
...
statusline.set = function()
  ...
  vim.opt.statusline = ''
    ...
    .. '%{v:lua.buvis.statusline.lhs()}' -- Red/green/orange modified/activity status.
    ...
    .. '%{v:lua.buvis.statusline.fileprefix()}' -- Relative path to file's directory.
    ...
    .. '%{v:lua.buvis.statusline.filetype()}' -- Filetype (not using %Y because I don't want caps).
    .. '%{v:lua.buvis.statusline.fileencoding()}' -- File-encoding if not UTF-8.
    ...
    .. '%{v:lua.buvis.statusline.rhs()}' -- Line/column info.
    .. '%*' -- Reset highlight group.
end
