...
local autocmd = function(name, pattern, cmd, opts)
  ...
  if cmd_type == 'function' then
    local key = buvis.util.get_key_for_fn(cmd, buvis.g.autocommand_callbacks)
    buvis.g.autocommand_callbacks[key] = cmd
    cmd = 'lua buvis.g.autocommand_callbacks.' .. key .. '()'
